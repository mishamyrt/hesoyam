...
const BackgroundUsecaseComponent: FC = () => {
  ...
  const cheats: number[] = useMemo(() => Object.keys(cheatsMap).map((key) => parseInt(key)), []);
  ...
  return (
    <div>
      <h1>Background</h1>
      <p>
        This is a demonstration of entering cheat codes without input fields. Type the codes that
        are listed below.
      </p>
